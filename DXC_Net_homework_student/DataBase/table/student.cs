...
namespace DXC_Net_homework_student
{
    public class student:ViewModelBase
    {
        ...
        public student(string name, string sex, string birthday="不知道", string phone="不知道", string address="不知道", int scoreYW=-1, int scoreSX = -1, int scoreYY = -1, string photoPath="")
        {
            _name=name;  _sex=sex; _birthday=birthday; _phone=phone; _address=address; _scoreYW = scoreYW;_scoreSX=scoreSX; _scoreYY=scoreYY;_photoPath=photoPath;
